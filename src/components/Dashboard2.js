          ...
          <table>
            ...
            <tr>
              <td>
                ...
                <span className={classes.details}>+91 8390148349</span>
              </td>
              <td>
                <span className={classes.tabledata}>Surgery Type:</span>
                <span className={classes.details}>Thie Surgery</span>
              </td>
              <td>
                <span className={classes.tabledata}>Anthesiologist:</span>
                <span className={classes.details}>Dr.Sachin Rathod</span>
              </td>
            </tr>
            ...
            <tr>
              <td>
                ...
                <span className={classes.details}>sandipu@leewayhertz.com</span>
              </td>
              <td>
                <span className={classes.tabledata}>Surgery Date:</span>
                <span className={classes.details}>03 June 2017 </span>
              </td>
              <td>
                <span className={classes.tabledata}>Anthesiologist phone:</span>
                <span className={classes.details}>993-356-4252</span>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                ...
                <span className={classes.details}>166 cms </span>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                ...
                <span className={classes.details}>61Kg </span>
              </td>
